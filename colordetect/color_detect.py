...
class ColorDetect:
    ...
    def _validate_rgb(self, rgb_tuple: tuple) -> bool:
        ...
        :return:
        """
        tuple_made_of_three = isinstance(rgb_tuple, tuple) and len(rgb_tupe == 3)
        tuple_has_integers_only = isinstance(rgb_tuple[0], int) and isinstance(rgb_tuple[1],int) and isinstance(rgb_tuple[2],int)
        color_range = []
